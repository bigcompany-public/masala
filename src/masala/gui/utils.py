...
This module contains helper functions used throughout masala_assembler to create the
...
def get_masala_assembler_icon() -> QIcon:
    """Return the default masala_assembler application icon."""
    icon = qtawesome.icon(
        "fa5s.square",
        "ph.package-bold",
        options=[
            {"scale_factor": 1.5, "color": "#23272E"},
            {"scale_factor": 1.0, "color": "#F34D00"},
        ],
    )
    return icon


def get_masala_exporter_icon() -> QIcon:
    """Return the default masala_exporter application icon."""
    icon = qtawesome.icon(
        "fa5s.square",
        "mdi6.package-up",
        options=[
